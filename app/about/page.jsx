...
const page = () => {
  return (
    // <div className='text-white md:px-44 px-12 w-screen h-full'>
    //   <div className='w-full h-full flex flex-col gap-6 mt-10 mb-20 relative'>
    //     <h3 className='font-bold text-2xl'>About Space.Inc</h3>
        ...
        // </div>
    //     <div className='pb-20'>
    //       <Spline scene="https://prod.spline.design/6gL6dzNIx3dKVwNV/scene.splinecode"/>
    //     </div>
    //        
    //   </div>
    // </div>
    <div className='flex flex-col md:px-44 px-12'>
